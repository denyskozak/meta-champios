...
async function joinChampionship(championshipId: string, leaderAddress: string, teamName: string, leadName: string, teammateNicknames: string[]) {
    try {
        ...
        tx.moveCall({
            ...
            arguments: [champ, leaderAddressParam, teamNameParam, nicknameParam, teammateNicknamesParam],
        });
